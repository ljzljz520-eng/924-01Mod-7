...
$campaign_slug = isset($_GET['campaign']) ? trim($_GET['campaign']) : '';
$campaign = $campaign_slug ? get_campaign_by_slug($campaign_slug) : null;
...
<div class="detail-wrap">
    <?php if ($campaign && is_campaign_active($campaign)): ?>
        <div style="margin-bottom:16px;">
            <a href="/campaign.php?slug=<?php echo e($campaign['slug']); ?>" class="btn btn-ghost" style="display:inline-flex;align-items:center;gap:6px;">
                ← 返回「<?php echo e($campaign['name']); ?>」专题
            </a>
        </div>
    <?php else: ?>
    ...
    <div class="detail-section download-box">
        ...
        <a class="btn btn-primary" href="<?php echo e($template['download_url']); ?>" target="_blank" rel="noopener" style="padding:14px 32px;font-size:1.1rem;" onclick="trackDownload()">立即下载</a>
...
const templateId = <?php echo (int) $template['id']; ?>;
